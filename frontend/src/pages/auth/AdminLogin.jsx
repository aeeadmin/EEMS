        ...
        <div style={{ maxWidth: '440px', width: '100%' }}>
          <div className="login-panel">
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
              ...
              <span className="login-role-icon" style={{ fontSize: '28px' }}>🛡️</span>
            </div>
            
            <h5 className="login-panel-title">Administrator Sign In</h5>
            <p className="login-panel-subtitle">Access approvals, audit logging, and email configurations.</p>
